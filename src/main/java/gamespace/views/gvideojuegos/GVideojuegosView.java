...
public class GVideojuegosView extends Div implements BeforeEnterObserver {
    ...
    private CollaborationBinder<Videojuego> binder;
    ...
    public GVideojuegosView(@Autowired VideojuegoService videojuegoService) {
        ...
        // Configure Form
        binder = new CollaborationBinder<>(Videojuego.class, userInfo);
    ...
    public void beforeEnter(BeforeEnterEvent event) {
        ...
        if (videojuegoId.isPresent()) {
            ...
            if (videojuegoFromBackend.isPresent()) {
                ...
                Notification.show(String.format("The requested videojuego was not found, ID = %d", videojuegoId.get()),
    ...
    private void populateForm(Videojuego value) {
        ...
        String topic = null;
        if (this.videojuego != null && this.videojuego.getId() != null) {
            topic = "videojuego/" + this.videojuego.getId();
            avatarGroup.getStyle().set("visibility", "visible");
        } else {
            avatarGroup.getStyle().set("visibility", "hidden");
        }
        binder.setTopic(topic, () -> this.videojuego);

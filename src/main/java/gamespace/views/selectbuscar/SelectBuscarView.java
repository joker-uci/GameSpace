package gamespace.views.selectbuscar;
...
@PageTitle("Select Buscar")
@Route(value = "select-buscar", layout = MainLayout.class)
@AnonymousAllowed
public class SelectBuscarView extends Div {
    ...
    public SelectBuscarView() {
        addClassName("select-buscar-view");
        setSizeFull();
        createGrid();
        add(grid);
    }
